      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
             ...
             <li  class="active"><a target="ifrm" href="<%=request.getContextPath()%>/data/crawls">数据采集</a></li>
             <li><a target="ifrm" href="<%=request.getContextPath()%>/blog/list">数据展示</a></li>
             <li><a target="ifrm" href="<%=request.getContextPath()%>/result/list/pr">影响力度量</a></li>
